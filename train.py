...
from dataset import ArgoverseV2DataModule
...
if __name__ == '__main__':
    ...
    model = Predictor(**vars(args))
    if args.pretained_ckpt:
        model.load_from_checkpoint(checkpoint_path=args.pretained_ckpt, strict=False)
