...
def create_boxes_info(av2_info, root_path, mono3d=True):
    ...
    for cam_name in camera_types:
        ...
        coco_infos = get_2d_boxes(av2_info, copy.deepcopy(cam_models[cam_name]), width, height, cam_imgs[cam_name], mono3d=True)
