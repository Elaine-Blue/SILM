...
class HiVT(pl.LightningModule):
    ...
    def validation_step(self, data, batch_idx):
        ...
        y_hat_best_agents = y_hat_[best_mode_agents, range(data.batch.size(0)), :, :].squeeze(0)
        ...
        self.log('val_minADE', self.minADE, prog_bar=True, on_step=False, on_epoch=True, batch_size=data.batch.size(0))
        self.log('val_minFDE', self.minFDE, prog_bar=True, on_step=False, on_epoch=True, batch_size=data.batch.size(0))
        self.log('val_minMR', self.minMR, prog_bar=True, on_step=False, on_epoch=True, batch_size=data.batch.size(0))
